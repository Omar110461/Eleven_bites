...
<body>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-10 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl  text- mb-10 lg:mb-14 lg:ml-3">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Recipe List</h2>
            <p class="mt-1 text-gray-600 ">This is a list of all the recipe</p>
        </div>
        ...
        <?php  foreach ($recipes as $recipeItmem ) : ?>
            ...
            <a class="group hover:bg-gray-100 rounded-xl p-5 transition-all" href='/details.php?recipe_id=<?php echo $recipeItmem ['recipe_id']; ?>'>
                <div class="aspect-w-16 aspect-h-10">
                    <img class="w-full object-cover rounded-xl"
                    src="<?php echo $recipeItmem['img_url'] ? $recipeItmem['img_url'] : 'https://site-images.similarcdn.com/url?url=https%3A%2F%2Fplay-lh.googleusercontent.com%2FuaTwQIlEjPHHsqdpnmxLoT_XAgFtLXCYFncGAc85xs0hoEnYqLiANRwjnQXzgLcDHxs%3Ds180&h=dcada0611cfbc2d0b01d7c854d6e3b7938d541940a571d06fe0dea864a91c260'?>"
