  ...
  <div class="max-w-2xl mx-auto divide-y divide-gray-200 ">
    <div class="py-8 first:pt-0 last:pb-0">
      <div class="flex gap-x-5">
        <svg class="flex-shrink-0 mt-1 size-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
        ...
        Learn more about app
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio deleniti quaerat ullam incidunt voluptates aperiam consequatur, officiis magni esse pariatur?
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 first:pt-0 last:pb-0">
      <div class="flex gap-x-5">
        ...
        <div>
          ...
          <p class="mt-1 text-gray-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae eaque nesciunt saepe animi quisquam!
          </p>
        </div>
      </div>
    </div>
